        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and lightAttackBimage == lightAttackB.Pimage:
                    if event.button == 1 and diss == 1:  # 1 represents left mouse button
                        ...
                        aimpointer = pygame.Rect(WIDTH//2-aimbw//2, 550, 15, aimhight)
                        ...
                        WIN.blit(AIMB, (WIDTH//2-aimbw//2, 550))
                        WIN.blit(AIMP, (WIDTH//2-aimbw//2+aimbw//2-aimpw//2, 550))
                        ...
                        while runn == 1:
                            ...
                            while disrun1 == 1:
                                aimpointer.x += 1
                                if aimpointer.x + aimpointer.width > WIDTH//2-aimbw//2 + aimbw:
                                    disrun1 = 0
                                WIN.blit(AIMB, (WIDTH//2-aimbw//2, 550))
                                WIN.blit(AIMP, (WIDTH//2-aimbw//2+aimbw//2-aimpw//2, 550))
                                WIN.blit(AIMPR, (aimpointer.x, aimpointer.y))
                            ...
                            while disrun2 == 1:
                                aimpointer.x -= 1
                                if aimpointer.x < WIDTH//2-aimbw//2:
                                    disrun2 = 0
                                WIN.blit(AIMB, (WIDTH//2-aimbw//2, 550))
                                WIN.blit(AIMP, (WIDTH//2-aimbw//2+aimbw//2-aimpw//2, 550))
                                WIN.blit(AIMPR, (aimpointer.x, aimpointer.y))
                        ...
                        if   WIDTH//2-aimbw//2+aimbw//2-aimpw//2 < aimpointer.x < WIDTH//2-aimbw//2+aimbw//2-aimpw//2 + aimpw:
